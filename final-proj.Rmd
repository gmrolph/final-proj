...
CO_SAT_salary_image %>% 
  ggsave(filename = file.path("StudentsInSchools", "colorado_sat_salary.png"))
```
...
CO_gendered_outcomes %>% 
ggsave(filename = file.path("StudentsInSchools", "colorado_gender_outcome.png"))
```
...
CN_expenditures_elascore %>% 
    ggsave(filename = file.path("StudentsInSchools", "connecticut_sat_ela_expenditure.png"))
...
CN_expenditures_mathscore %>% 
      ggsave(filename = file.path("StudentsInSchools", "connecticut_sat_math_expenditure.png"))
...
CN_sat_staffdemos %>% 
    ggsave(filename = file.path("StudentsInSchools", "connecticut_sat_staffdemos.png"))
```
...
florida_teachers %>% 
    ggsave(filename = file.path("StudentsInSchools", "florida_teachers.png"))
...
florida_superintendents %>% 
    ggsave(filename = file.path("StudentsInSchools", "florida_superintendents.png"))
...
florida_school_board %>% 
    ggsave(filename = file.path("StudentsInSchools", "florida_school_board.png"))
```
...
IN_sat_spending %>% 
    ggsave(filename = file.path("StudentsInSchools", "indiana_sat_spending.png"))
...
IN_act_spending %>% 
    ggsave(filename = file.path("StudentsInSchools", "indiana_act_spending.png"))
...
KY_ACT_expenditure %>% 
    ggsave(filename = file.path("StudentsInSchools", "kentucky-act-expenditure.png"))
...
KY_ACT_teacher %>% 
    ggsave(filename = file.path("StudentsInSchools", "kentucky-act-teacher.png"))
...
KY_ACT_principal %>% 
    ggsave(filename = file.path("StudentsInSchools", "kentucky-act-principal.png"))
```
...
MA_SAT_PPE_math %>% 
    ggsave(filename = file.path("StudentsInSchools", "mass-sat-ppe-math.png"))
...
MA_SAT_PPE_reading %>% 
    ggsave(filename = file.path("StudentsInSchools", "mass-sat-ppe-reading.png"))
...
MA_SAT_demos_reading %>%     
  ggsave(filename = file.path("StudentsInSchools", "mass-sat-demos-reading.png"))
...
MA_SAT_demos_math %>%     
  ggsave(filename = file.path("StudentsInSchools", "mass-sat-demos-math.png"))
...
MA_SAT_sals_reading %>% 
    ggsave(filename = file.path("StudentsInSchools", "mass-sat-sals-reading.png"))
...
MA_SAT_sals_math %>% 
    ggsave(filename = file.path("StudentsInSchools", "mass-sat-sals-math.png"))
```
...
NV_demo_outcomes %>%     
  ggsave(filename = file.path("StudentsInSchools", "nv-demo-outcomes.png"))
...
NV_financial_outcomes %>% 
    ggsave(filename = file.path("StudentsInSchools", "nv-financial-outcomes.png"))
```
...
OK_ACT_staff_graph %>% 
    ggsave(filename = file.path("StudentsInSchools", "ok-act-staff.png"))
...
OK_ACT_supt %>% 
    ggsave(filename = file.path("StudentsInSchools", "ok-act-supt.png"))
```
...
PA_ACT_grad %>% 
   ggsave(filename = file.path("StudentsInSchools", "pa-grad-rate.png"))
```
...
SC_SAT_financial %>% 
     ggsave(filename = file.path("StudentsInSchools", "sc-sat-financial.png"))
...
SC_ACT_financial %>% 
    ggsave(filename = file.path("StudentsInSchools", "sc-act-financial.png"))
...
SC_SAT_demos %>% 
      ggsave(filename = file.path("StudentsInSchools", "sc-sat-demos.png"))
...
SC_ACT_demos %>% 
        ggsave(filename = file.path("StudentsInSchools", "sc-act-demos.png"))
...
SD_ACT_stsr %>% 
    ggsave(filename = file.path("StudentsInSchools", "sd-act-stsr.png"))
...
TN_ACT_demos %>% 
      ggsave(filename = file.path("StudentsInSchools", "tn-act-demos.png"))
...
TN_ACT_expenditures %>% 
        ggsave(filename = file.path("StudentsInSchools", "tn-act-expenditures.png"))
...
TN_demos_expenditures %>% 
          ggsave(filename = file.path("StudentsInSchools", "tn-demos-expenditures.png"))
...
TX_ACT_financial %>% 
            ggsave(filename = file.path("StudentsInSchools", "tx-act-financial.png"))
...
TX_SAT_financial %>% 
    ggsave(filename = file.path("StudentsInSchools", "tx-sat-financial.png"))
...
WI_ACT_financial %>% 
      ggsave(filename = file.path("StudentsInSchools", "wi-act-financial.png"))
...
WY_ACT_salary %>% 
    ggsave(filename = file.path("StudentsInSchools", "wy-act-salary.png"))
```
...
fake_states_groupings %>% 
    ggsave(filename = file.path("StudentsInSchools", "fake-correlations.png"))
